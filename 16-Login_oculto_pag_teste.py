# Desafio -  Realizar login com headless na página de testes https://cursoautomacao.netlify.app/
# Usar modo segundo plano fazendo com o que o PC fique livre para outras tarefas
...
# Função para buscar elementos na página
...
# ACESSAR O LINK LOGIN
busca_elemento("//a[text()='Login']").click()

# PASSAR O EMAIL 
busca_elemento("//input[@id='email']").send_keys('dev_aprender@gmail.com')

sleep(1)

# PASSAR A SENHA 
busca_elemento("//input[@id='senha']").send_keys('12345678')

sleep(1)

# CLICAR NO BOTAO ENVIAR 
busca_elemento("//button[@type='submit']").click()

sleep(2)

# VERIFICA O RESULTADO E IMPRIMI NO TERMINAL
resultado = busca_elemento("//h1")
