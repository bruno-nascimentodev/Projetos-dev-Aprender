...
# Navegando ate a página 
driver.get('https://cursoautomacao.netlify.app/')
sleep(1)

# Rolando até o frame desejado 
...
# Buscando elemento dentro do frame 
campo_text = driver.find_element(By.ID,"dadosusuario")
campo_text.send_keys("Bruno Moura do Nascimento")
sleep(1)

# Buscando elemento dentro do frame 
botao_text = driver.find_element(By.ID,"desafio2")
driver.execute_script('arguments[0].click()',botao_text)
sleep(1)

# Buscando elemento dentro do frame 
campo_escondido = driver.find_element(By.ID,"escondido")
campo_escondido.send_keys("Bruno")
sleep(1)

# Rolando a página para o encontar o botão
driver.execute_script("window.scrollTo(0, 200);")
sleep(1)

# Buscando elemento dentro do frame 
botao_escondido = driver.find_element(By.ID,"validarDesafio2")
driver.execute_script('arguments[0].click()',botao_escondido)
sleep(1)
...
# Rolando a página de volta para cima 
