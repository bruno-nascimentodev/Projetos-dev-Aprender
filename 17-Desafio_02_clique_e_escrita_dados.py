# DESAFIO  
# 1.Digite seu nome no campo abaixo
# 2.Clique no botão abaixo usando selenium
...
campo_nome = driver.find_element(By.XPATH,"//input[@id='dadosusuario']")
campo_nome.send_keys("Bruno")

sleep(1)

# CLICAR NO BOTÃO PARA ENVIAR 
botao_enviar = driver.find_element(By.XPATH,"//button[@id='desafio2']")
botao_enviar.click()

sleep(1)

# DIGITA O NOME NOVAMENTE 
campo_nome2 = driver.find_element(By.XPATH,"//input[@id='escondido']")
campo_nome2.send_keys('Bruno')

sleep(1)

# VALIDA O NOME DIGITADO 
validar = driver.find_element(By.XPATH,"//button[@id='validarDesafio2']").click()
